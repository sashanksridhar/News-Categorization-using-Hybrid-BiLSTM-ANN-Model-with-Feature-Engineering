...
with open("trainWordsL3.csv", 'r', encoding='latin1') as csv1:
...
model = load_model("L3MultiHybridMultioutput10.h5")
...
with open("testWordsL3.csv", 'r', encoding='latin1') as csv1:
    # creating a csv reader object
    csvreader1 = csv.reader(csv1)
...
# for i in range(0,8):
#     pred.append([])
predicted = model.predict([x_train,x_train1,x_train2])
print(len(predicted))
ytrue = []
